---
title: "Improve Site Name Handling and Tag Page Mobile Layout"
date: 2025-09-22
authors: 
- Michael Staton
...
# Summary
Enhanced site name handling logic to use properly cased filenames and improved URL fallbacks, while fixing mobile layout spacing issues on tag pages by removing redundant "Related Tags" text and adding appropriate responsive margins.

## Why Care
These changes significantly improve the user experience by displaying more meaningful and properly formatted site names instead of URLs, while ensuring the tag pages look polished on mobile devices. The improvements make the toolkit more professional and easier to navigate across all screen sizes.
