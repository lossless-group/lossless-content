...
A working reference for the licenses that show up most often when surveying open source, source-available, and "open-ish" projects. Roughly grouped: permissive → weak copyleft → strong copyleft → network copyleft → public-domain dedications → source-available (not OSI-approved). For the philosophical frame, see [[concepts/Copyleft|Copyleft]].
...
- [[concepts/Copyleft]]
- [[organizations/Free Software Foundation]]
