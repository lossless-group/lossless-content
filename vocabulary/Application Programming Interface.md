...
- Common API authentication and authorization methods include [[projects/Emergent-Innovation/Standards/Transport Layer Security|TLS]] encryption, [[projects/Emergent-Innovation/Standards/OAuth]] 2.0, and [[projects/Emergent-Innovation/Standards/JSON Web Tokens|JWT]]-based authentication. 
...
- [[projects/Emergent-Innovation/Standards/GraphQL]] is a newer type of protocol that allows for more efficient data retrieval.
...
> 
> 1. **[[Tooling/Software Development/Lego-Kit Engineering Tools/Swagger API]] ([[projects/Emergent-Innovation/Standards/The Open API Initiative|OpenAPI]])**: A suite of tools for designing, documenting, and building RESTful APIs.
