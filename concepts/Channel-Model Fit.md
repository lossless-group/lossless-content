...
![Simple 2×2 matrix showing “Business Model” on one axis and “Growth / Acquisition Channels” on the other, with the top-right cell labeled “Channel–Model Fit”](https://images.squarespace-cdn.com/content/v1/528c45f9e4b06be250a9fe30/1500383995468-5VD2AJJXFPAY125K9D6R/Wheel+Of+Fits+Presentation+-+B2B+Marketing+Conference.001+%282%29.jpeg)
...
```mermaid
flowchart LR
    A[Business Model] --> B[Key Parameters<br/>• ACV / price point<br/>• Sales cycle length<br/>• Buyer type<br/>• Implementation complexity]
    B --> C[Feasible Channels<br/>• Self-serve / PLG<br/>• Inside sales<br/>• Enterprise outbound<br/>• Partnerships / resellers]
    C --> D[Observed Performance<br/>• CAC & payback<br/>• Conversion rates<br/>• Churn & expansion]
    D --> E[Channel–Model Fit Assessment<br/>Good ↔ Poor]
    E -->|If poor| F[Adjust channels or<br/>rethink model]
```
