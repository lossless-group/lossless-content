...
![Simplified diagram showing a company split into front office (sales, customer support) and back office (HR, accounting, IT, operations) with arrows indicating support flows](https://community.dynamics.com/api/data/v9.1/msdyn_richtextfiles%28B090130B-3886-499E-8637-0C118C0B3E9C%29/msdyn_imageblob/$value?size=full)
...
![Illustration of an Employer of Record sitting between multiple staffing agencies and workers, handling payroll, tax filings, and compliance as centralized back-office services](https://doc.oroinc.com/_images/ex_permissions-on-entity.png)
